      ...
      <div className="max-w-[1280px] mx-auto px-spacing-5xl py-spacing-10xl flex flex-col gap-y-spacing-8xl">
        ...
        >
          <motion.div
            ...
            className=" overflow-hidden relative md:col-span-2 p-spacing-4xl rounded-2xl border border-border-gray-secondary bg-bg-gray-soft-primary min-h-[416px]"
          >
          ...
          <motion.div
            variants={fadeUp}
            whileHover={{ y: -6, transition: { duration: 0.25 } }}
            className=" overflow-hidden flex flex-col justify-between gap-spacing-4xl p-spacing-4xl rounded-2xl border border-border-gray-secondary bg-bg-gray-soft-primary"
          >
            <Image
          ...
          <motion.div
            variants={fadeUp}
            whileHover={{ y: -6, transition: { duration: 0.25 } }}
            className=" overflow-hidden flex flex-col items-center justify-between gap-spacing-5xl  rounded-2xl border border-border-gray-secondary bg-bg-gray-soft-primary"
          >
          ...
          <motion.div
            variants={scaleIn}
            whileHover={{ y: -6, transition: { duration: 0.25 } }}
            className=" overflow-hidden flex flex-col justify-between gap-spacing-5xl  rounded-2xl border border-border-gray-secondary bg-bg-gray-soft-primary"
          >
            <div className=" space-y-spacing-2xl p-spacing-4xl">
              <p className=" text-heading-sm font-heading-sm-strong! text-text-gray-secondary">
