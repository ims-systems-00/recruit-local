...
const educationSchema = educationInputSchema.shape({
  _id: objectIdSchema.required(),
});
const experienceSchema = experienceInputSchema.shape({
  _id: objectIdSchema.required(),
});
const interestSchema = interestInputSchema.shape({
  _id: objectIdSchema.required(),
});
...
export const cvSchema = yup.object({
  ...
  resumeStorage: awsStorageSchema.nullable().optional(),
...
export const createCvSchema = yup.object({
  title: yup.string().required('Title is required').default('Untitled CV'),
...
export const updateCvSchema = yup.object({
  ...
  colorProfile: yup.string().optional(),
  //   statusId: yup
  //     .mixed<CV_STATUS_ENUM>()
  //     .oneOf(Object.values(CV_STATUS_ENUM))
  //     .optional(),
  statusId: objectIdSchema.optional(),
});
