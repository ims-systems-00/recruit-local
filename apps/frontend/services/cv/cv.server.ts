...
export async function getCvs(
    ...
    try {
        ...
        return {
            ...
            message: validated.message || 'CVs fetched successfully',
        };
    } catch (error) {
...
export async function getCvById(
    ...
    try {
        ...
        return {
            success: true,
            data: validated.cv,
            message: validated.message || 'CV retrieved successfully',
        };
    } catch (error) {
...
export async function updateCv(
    ...
    try {
        ...
        const res = await axiosServer.put(`${API_ENDPOINT}/${id}`, validatedPayload);
        ...
        return {
            success: true,
            data: validatedResponse.cv,
            message: validatedResponse.message || 'CV updated successfully',
        };
    } catch (error) {
 ...
 * SOFT DELETE CV
 */
export async function softDeleteCv(
    id: string,
): Promise<CvApiResponse<null>> {
    try {
        await idParamsSchema.validate({ id });
        ...
        return {
            success: true,
            data: null,
            message: validatedResponse.message || 'CV moved to trash',
        };
    } catch (error) {
