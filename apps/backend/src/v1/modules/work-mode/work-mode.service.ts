...
type IListWorkModeParams = IListParams<WorkModeInput> & { offset?: number };
type IWorkModeQueryParams = ListQueryParams<WorkModeInput>;

export const list = async ({ query = {}, options, offset = 0 }: IListWorkModeParams) => {
...
export const update = async ({ query, payload }: { query: IWorkModeQueryParams; payload: Partial<WorkModeInput> }) => {
