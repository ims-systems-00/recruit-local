...
import { createStatusBodySchema, updateStatusBodySchema, statusListQuerySchema } from "./status.validation";
import { list, get, create, update, softRemove, hardRemove, restore } from "./status.controller";
