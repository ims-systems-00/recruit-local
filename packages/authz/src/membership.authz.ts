...
export class MembershipAuthZEntity {
...
type ClaimAbility = PureAbility<
  AbilityTuple,
  MongoQuery<typeof MembershipAuthZEntity>
>;
const ClaimAbility = PureAbility as AbilityClass<ClaimAbility>;

export class MembershipAbilityBuilder implements IAbilityBuilder {
  ...
  getAbility(): AnyAbility {
    ...
    if (this.session.user.type === USER_TYPE_ENUMS.CUSTOMER) {
      // builder.can(AbilityAction.Manage, MembershipAuthZEntity);
    }
