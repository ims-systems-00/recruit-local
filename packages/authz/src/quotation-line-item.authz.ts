...
export class QuotationLineItemAuthZEntity {
...
type ClaimAbility = PureAbility<
  AbilityTuple,
  MongoQuery<typeof QuotationLineItemAuthZEntity>
>;
const ClaimAbility = PureAbility as AbilityClass<ClaimAbility>;

export class QuotationLineItemAbilityBuilder implements IAbilityBuilder {
  ...
  getAbility(): AnyAbility {
    ...
    if (this.session.user.type === USER_TYPE_ENUMS.CUSTOMER) {
      // builder.can(AbilityAction.Manage, QuotationLineItemAuthZEntity);
    }
