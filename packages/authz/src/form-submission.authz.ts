...
export class FormSubmissionAuthZEntity {
...
type ClaimAbility = PureAbility<
  AbilityTuple,
  MongoQuery<typeof FormSubmissionAuthZEntity>
>;
const ClaimAbility = PureAbility as AbilityClass<ClaimAbility>;

export class FormSubmissionAbilityBuilder implements IAbilityBuilder {
  ...
  getAbility(): AnyAbility {
    ...
    if (this.session.user.type === USER_TYPE_ENUMS.CUSTOMER) {
      // builder.can(AbilityAction.Manage, FormSubmissionAuthZEntity);
    }
